...
-- Last modification date: 2019-05-14 17:57:13.872
...
CREATE TABLE BuildingLocation (
    ...
    HouseStreet nvarchar(50)  NOT NULL,
...
CREATE TABLE Disposition (
    ...
    DispositionCode nvarchar(5)  NOT NULL,
    DispositionDescription nvarchar(100)  NOT NULL,
